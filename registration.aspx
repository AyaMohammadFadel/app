<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="my_app_aya.WebForm1" %>
    ...
    <form id="form1" runat="server">
            ...
            <asp:Panel ID="p_sInfo" runat="server"  GroupingText="البيانات الشخصية" Direction="RightToLeft">
                <table dir="ltr" class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style9">
                            <asp:RadioButton ID="rb_sMale" runat="server"  TextAlign="Left" Text="ذكر" GroupName="gender" />
            ...
            <table dir="ltr" class="auto-style1">
               ...
               <table>
                   <tr>
                       <td>
                           <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Button" ValidationGroup="registration" PostBackUrl="~/AfterRegister.aspx" />
                       </td>
                   </tr>
                   <tr>
                       <td>
...
<script type="text/javascript" language="javascript"> 
    ...
    {
       // if (arguments.value.lenght == 14)
      
    //    if (document.getElementById("txt_sNid").innerText.length == 14)

        var txtvalue = document.getElementById('<% =txt_sNid.ClientID %>').value;
        if (txtvalue.lenght== 14)
        {
            alert(txtvalue.toString());
